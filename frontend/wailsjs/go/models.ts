export namespace main {
	...
	export class TwitchPermissionItem {
	    ...
	    static createFrom(source: any = {}) {
	        return new TwitchPermissionItem(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.missingScopes = source["missingScopes"];
	    }
	}
	export class TwitchPermissionCheck {
	    checkedAt: string;
	    overall: string;
	    items: TwitchPermissionItem[];

	    static createFrom(source: any = {}) {
	        return new TwitchPermissionCheck(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.items = this.convertValues(source["items"], TwitchPermissionItem);
	    }
